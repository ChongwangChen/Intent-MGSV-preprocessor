param(
    ...
    [string]$RemotePython = "/data/conda/envs/mgsv_data/bin/python",
...
$remoteCommand = "cd '$RemoteRoot' && source config/server.env && '$RemotePython' -m intent_mgsv_pipeline.server.collect_diagnostics --recent $Recent --out '$remoteReport'"
